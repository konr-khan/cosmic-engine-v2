...
│   └── adr/                     # Architecture Decision Records (ADRs 0001-0012)
└── src/
...
| **Observatory Widgets** | `src/components/widgets/widgets.test.ts` (44 tests) | Modular barrel exports, contract assertions, and integrated domain ephemeris across all 8 observatory window subsystems, including camera pole timing and depth stroke unification |
