...
- **Testing**: `vitest` (104 automated unit tests across 5 test suites: pure math, hooks, state store, error boundaries, and worker fallback)
...
# Run Vitest test suite (104 unit tests across 5 suites)
npm test
...
│   │   └── cosmicMath.test.js   # Vitest unit tests for math engine (63 tests)
...
| :--- | :--- | :--- | :--- |
| **Cosmic Math** | `src/utils/cosmicMath.test.js` | 63 | Polar daylight singularities ($\pm 90^\circ$, continuous twilight), Julian dates, Meeus lunar series, nodal precession ($\Omega$), 365/366-day solar & lunar matrices, eclipse presets & real-world eclipse edge cases |
