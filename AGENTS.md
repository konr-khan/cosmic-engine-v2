...
- **Testing**: `vitest` (`npm test` — comprehensive domain test suite across 21 modules, 412 tests)
...
│       │   ├── widgets.test.ts  # Vitest unit tests for 8 observatory widgets (40 tests)
