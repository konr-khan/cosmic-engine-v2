...
export interface SolarShortcut {
  label: string;
  day: number;
  title: string;
}

export interface SolarShortcutsRailProps {
  shortcuts: SolarShortcut[];
  activeDay: number;
  onDayChange?: (day: number) => void;
}

export const SolarShortcutsRail: React.FC<SolarShortcutsRailProps> = ({
  shortcuts,
  activeDay,
  onDayChange
}) => {
...
export default SolarShortcutsRail;
